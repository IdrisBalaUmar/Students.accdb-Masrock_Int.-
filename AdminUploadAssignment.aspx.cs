...
{
    public partial class AdminUploadAssignment : System.Web.UI.Page
    {
        ...
        private DataTable GetData()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("SELECT AssTitle,AssDesc,Name,AssTime FROM AdminAssignments"))
                {
        ...
        {
            cmd.CommandText = "select AssTitle,AssDesc,Name,AssTime from  AdminAssignments";
            cmd.Connection = con;
            da.SelectCommand = cmd;
            da.Fill(ds, "AdminAssignments");
            SqlCommandBuilder cb = new SqlCommandBuilder(da);

            DataRow drow = ds.Tables["AdminAssignments"].NewRow();
            ...
            ds.Tables["AdminAssignments"].Rows.Add(drow);
            da.Update(ds, "AdminAssignments");
