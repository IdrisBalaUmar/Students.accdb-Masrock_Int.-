<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUploadCourseware.aspx.cs" Inherits="GISystematix_Asp.AdminUploadCourseware" %>
...
<head>
    ...
    <title>Admin</title>	<!-- BOOTSTRAP STYLES-->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu" href="AdminUploadCourseware.aspx"><i class="glyphicon glyphicon-list-alt" ></i> <!--UI Elements-->View Uploaded Courseware</a>
                    </li>
                    <li>
